...
/**
 * This class provides an empty implementation of {@link simpleBibTeXVisitor},
...
public class simpleBibTeXBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements simpleBibTeXVisitor<T> {
	/**
	 * {@inheritDoc}
	 *
	 ...
	 */
	@Override public T visitDatabase(simpleBibTeXParser.DatabaseContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
